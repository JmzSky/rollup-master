...
var Fetch = function () {
  ...
  _createClass(Fetch, [{
    key: 'httpHeaders',
    value: function httpHeaders(headers) {
      var _headers = {
    ...
    key: 'injectRequest',
    value: function injectRequest(config) {
    ...
    key: 'injectResponse',
    value: function injectResponse(response) {
      return response;
    }
    ...
    key: 'injectError',
    value: function injectError(err) {
      var result = {
    ...
    value: function instance() {
      ...
      instance.interceptors.request.use(function (config) {
        return _this.injectRequest(config);
      }, function (error) {
        return Promise.reject(_this.injectError(error));
      });

      instance.interceptors.response.use(function (response) {
        return _this.injectResponse(response);
      }, function (error) {
        return Promise.reject(_this.injectError(error));
      });
      this.fetch = instance;
...
var types = {
   ...
   * @private
   */
};var StorageKey = 'AIAGAIN_JSDK2019062613';
/**
 * 内存存储
 * @type {{}}
 * @private
...
var cacheType = {
   ...
   * @private
   */
};var config = (_config2 = {}, _defineProperty(_config2, types.token, {
  cacheType: cacheType.session
}), _defineProperty(_config2, types.userInfo, {
  cacheType: cacheType.session
}), _defineProperty(_config2, types.userConfig, {
  cacheType: cacheType.session
}), _defineProperty(_config2, types.appConfig, {
  cacheType: cacheType.session
}), _defineProperty(_config2, types.wxConfig, {
  cacheType: cacheType.session
}), _config2);
/**
 * 判断是否过期
 ...
 * @returns {boolean}
 */
var computeExpires = function computeExpires(value) {
  var res = (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object';
  if (res) {
 ...
 * @private
 */
var winGetItem = function winGetItem(storage) {
  return function (key) {
    var cache = storage['getItem'](StorageKey) || '{}';
 ...
 * @private
 */
var winSetItem = function winSetItem(storage) {
  /**
 ...
 * @private
 */
var winRemoveItem = function winRemoveItem(storage) {
  /**
   * @param {String} key -存储key,来源 types
   */
  return function (key) {
 ...
 */
var createStore = function createStore(storage) {
  return {
 ...
 * @private
 */
var Cache = (_Cache = {}, _defineProperty(_Cache, cacheType.memory, {
...
}), _defineProperty(_Cache, cacheType.session, createStore(window.sessionStorage)), _defineProperty(_Cache, cacheType.local, createStore(window.localStorage)), _Cache);
...
var filter = function filter(ajax, cacheType) {
  var result = null;
  if (cacheType) {
 ...
 * @returns {Promise<*>}
 */
var userConfig = async function userConfig() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var url = '/userConfig';
  return filter(fetch({ url: url, method: 'get', params: params }), types.userConfig);
};
 ...
 * @returns {Promise<*>}
 */
var appConfig = async function appConfig() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var url = '/appConfig';
  return filter(fetch({ url: url, method: 'get', params: params }), types.appConfig);
};
 ...
 * @returns {Promise<*>}
 */
var lottery = async function lottery() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
 ...
 * @returns {Promise<*>}
 */
var wxJsdkConfig = async function wxJsdkConfig() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var url = '/wxJsdk';
  return filter(fetch({ url: url, method: 'get', params: params }));
};
 ...
 * @returns {Promise<*>}
 */
var prizeList = async function prizeList() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
 ...
 * @returns {Promise<*>}
 */
var authorization = async function authorization() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var url = '/authorization';
  return filter(fetch({ url: url, method: 'get', params: params }), types.token);
};

var version = '1.0.0';
var dev = window.name === 'dev';
var events = [];
...
var baseData = function baseData() {
  return new Promise(function (resolve, reject) {
    Promise.all([userConfig(), appConfig()]).then(function (values) {
      var shareData = values[1].wxShare;
      wxShare(shareData);
      resolve({
        userConfig: values[0],
        appConfig: values[1]
...
var wxLogin = function wxLogin() {
  authorization().then(function (res) {
    wxConfig();
  });
};
...
var wxConfig = function wxConfig() {
  ...
  wxJsdkConfig().then(function (res) {
    wx.config(res);
  });
};

var wxShare = function wxShare(data) {
...
var aiagain = {
  version: version,
  develop: dev,
  devUpdate: function devUpdate(callback) {
